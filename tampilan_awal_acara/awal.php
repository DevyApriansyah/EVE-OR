...
<html>
    ...
    ?>
		...
		<div class="iteam-grids">
					<div class="container">
						<div class="col-md-3">
							<div onclick="location.href='../tampilan_acara_membuat_acara/index.php';" class="iteam-grid text-center">
								<img src="images/tambah.png" title="name" />
								<a href="../tampilan_acara_membuat_acara/index.php"><label>Tambah Acara</label></a>
							</div>
						</div>
						</div>
					</div>
