...
<html>
	...
	<body>
		...
		<img src="../tampilan_sponsor_edit_profile/file/<?php echo $data['image']?>" title="image">
		</form>
	<br>

					<h2><label><?php echo $data['name']; ?></label></h2>
          <h3><label>Deskripsi Sponsor</label></h3> <br>
          ...
          <form action="proposal.php" method="post" enctype="multipart/form-data">
      		...
      		<input type="submit" name="upload" value="Upload Proposal"> <br>
      	</form>
