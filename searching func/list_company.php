  ...
  if (isset($_SESSION['committee'])){
    ...
    $keyword=$_GET['keyword'];
    	if(empty($keyword)){
    		...
    		$queryyy = mysqli_query($conn, "SELECT * FROM user WHERE name LIKE '%{$keyword}%'");
		...
		<div class="iteam-grids">
            ...
            <?php
                ...
                while($hasil = mysqli_fetch_array($queryyy)){
                  ...
                  <div onclick=location.href="../deskripsi/deskripsispo.php?id='.$hasil['user_id'].'";>
                            <div class="iteam-grid text-center">
                            <img src="../deskripsi/file/'.$hasil['image'].'" title="name" /> <br>
                              <a href="../deskripsi/deskripsispo.php?id='.$hasil['user_id'].'"><label>'.$hasil['name'].'</label></a>
								<ul>
									<li><a class="cart" href="#">Sponsori</a></li>
									<li><a class="more" href="../deskripsi/deskripsispo.php?id='.$hasil['user_id'].'">Details</a></li>
									<div class="clearfix"> </div>
								</ul>
              </div>
              </div>
